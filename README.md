...
- [Komos Regulated Ops Playbooks](https://github.com/xuanli/komos-regulated-ops-playbooks) – Public CRA, FCRA, insurance eligibility, and banking operations browser automation playbooks with JSON fixtures and evidence capture schemas.
