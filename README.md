...
- [Funding Signals](https://fundingsignals.net/docs) – REST API that surfaces companies the moment they raise capital from public SEC Form D filings, scored 0-100 as sales leads with domain/contact enrichment.
