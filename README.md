...
- - [Clicks Protocol](https://clicksprotocol.xyz) - autonomous DeFi yield layer for AI agents on Base. Auto-splits USDC 80/20 between liquid and yield (Morpho/Aave V3). SDK, MCP Server, and HTTP API. [GitHub](https://github.com/clicks-protocol/clicks-protocol)
