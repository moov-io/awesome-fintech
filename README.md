...
## Financial Data & APIs
- [BDE Score](https://github.com/hbhqq9/bde-score) – Open-source multi-factor stock scoring API providing real-time composite scores across US, HK, and A-Share markets.
