...
- [upi-intent](https://github.com/shambu2k/upi-intent) - Framework-agnostic JS/TS library for generating UPI app-specific deep links with robust Android and iOS fallbacks for payment flows
