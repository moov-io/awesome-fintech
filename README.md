...
- [FilingFirehose](https://filingfirehose.com) – SEC EDGAR JSON API with body-text-classified 8-Ks (catches 7.3% of recent Item 8.01 filings with buried 1.05/5.02 events), Schedule 13D/G with 21+ activist filers auto-tagged, S-3/424B5 ATM offering detection. Includes hosted MCP server at `filingfirehose.com/mcp`, ChatGPT custom GPT, Python SDK, and GitHub Action. Free public tier covers past 72h; paid from $29/mo.
