...
- [Tapetide MCP](https://github.com/Tapetide-hq/nse-bse-indian-stock-market-data-mcp) – MCP server and API for Indian stock markets to search, screen, and analyze NSE/BSE stocks with quotes, financials, and institutional flows.
