...
## Stock data
- [Vedika Astrology Finance API](https://vedika.io) - AI-powered Vedic astrology API for financial markets - provides muhurta timing, planetary transits, dasha periods, and market sentiment analysis via REST API
